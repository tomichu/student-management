...
feature 'スタッフによる生徒管理' do
	...
	scenario 'スタッフが生徒（基本情報のみ）を変更する' do
		click_link '生徒管理'
	...
	scenario 'スタッフが生年月日と自宅の郵便番号に無効な値を入力する' do
		click_link '生徒管理'
		first('table.listing').click_link '編集'
	...
	scenario 'スタッフが勤務先データのない既存生徒に会社名の情報を追加する' do
